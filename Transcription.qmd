...
required_packages <- c("tuneR", "seewave", "audio", "speech", "tidyverse", "text", "reticulate", "av", "googleLanguageR", "tidytext", "dplyr", "udpipe", "topicmodels", "tm", "ggplot2", "sqldf", "textrank", "hunspell", "viridis")
